    ...
    <div class="mdk-drawer-layout__content page">
        ...
        <div class="container-fluid page__container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <form action="{{ route('admin.ml-model.store') }}" class="form-insert" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check" style="margin-bottom: 10px; padding-left: 0px">
                                                <input class="form-check-input" type="radio" name="scaler" value="-" checked>
                                                <label class="form-check-label" style="margin-left: 5px">-</label>
                                            </div>
                                            <div class="form-check" style="margin-bottom: 10px; padding-left: 0px">
                                                <input class="form-check-input" type="radio" name="scaler" value="MINMAX">
                                                <label class="form-check-label" style="margin-left: 5px">MINMAX</label>
                                            </div>
                                            <div class="form-check" style="margin-bottom: 10px; padding-left: 0px">
                                                <input class="form-check-input" type="radio" name="scaler" value="ZSCORE">
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control dropify" name="joblib"/>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="features" class="form-control" id="features" cols="30" rows="10" placeholder="'SYN Flag Count', 'Fwd Seg Size Min', 'FWD Init Win Bytes', 'Average Packet Size', ...">{{ old('features') }}</textarea>
