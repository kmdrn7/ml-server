    ...
    <div class="mdk-drawer-layout__content page">
        ...
        <div class="container-fluid page__container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{ route('admin.pharmacy.store') }}" class="form-insert" method="POST">
                            @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                @else
                                                    <small class="text-muted">Masukkan name klinik</small>
                                                @endif
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label for="address">Alamat</label>
                                                <textarea name="address" id="address" cols="30" rows="7" class="form-control">{{ old('address') }}</textarea>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input class="form-control" type="text" name="latitude" id="latLabel" placeholder="" value="{{ old('latitude') }}" readonly>
                                                <input class="form-control" type="hidden" name="lat" id="lat" placeholder="" value="{{ old('lat') }}">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input class="form-control" type="text" name="longitude" id="longLabel" placeholder="" value="{{ old('longitude') }}" readonly>
                                                <input class="form-control" type="hidden" name="long" id="long" placeholder="" value="{{ old('long') }}">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input class="form-control" type="text" name="phone" id="phone" placeholder="" value="{{ old('phone') }}" autofocus>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input class="form-control" type="text" name="alpha" id="alpha" placeholder="" value="{{ old('alpha') }}">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="beta">Password</label>
                                                <input class="form-control" type="password" name="beta" id="beta" placeholder="" value="{{ old('beta') }}">
                                                @if( $errors->first('beta') )
                                                    <small class="text-red">{{ $errors->first('beta') }}</small>
                                                @else
                                                    <small class="text-muted">Masukkan password</small>
                                                @endif
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="beta_confirmation">Konfirmasi Password</label>
                                                <input class="form-control" type="password" name="beta_confirmation" id="beta_confirmation" placeholder="" value="{{ old('beta_confirmation') }}">
                                                @if( $errors->first('beta_confirmation') )
                                                    <small class="text-red">{{ $errors->first('beta_confirmation') }}</small>
                                                @else
                                                    <small class="text-muted">Konfirmasi konfirmasi password</small>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
...
@section('js')
    <script>
        ...
        function showPosition(position) {
            ...
            try {
                document.getElementById('lat').value = String(lati);
                document.getElementById('long').value = String(longi);
            } catch (error) {
