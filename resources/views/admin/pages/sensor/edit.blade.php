                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="mongo_db" id="mongo_db" placeholder="" value="{{ $config->MONGODB_DATABASE }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="mongo_col" id="mongo_col" placeholder="" value="{{ $config->MONGODB_COLLECTION }}">
